...
model_info = {
    ...
    "textbpn_mlt" : {
        "path":"models/TextBPN_resnet50_300_MLT.pth",
        "url": "https://github.com/Bhashini-IITJ/SceneTextDetection/releases/download/TextBPN%2B%2B/MLT_TextBPN_resnet50_300.pth",
...
class TextBPNpp_detector:
    def __init__(self, model_name="textbpn_mlt", backbone="resnet50", device="cpu"):
        """
...
if __name__ == "__main__":
    ...
    detector = TextBPNpp_detector(args.model_name, device="cuda")
